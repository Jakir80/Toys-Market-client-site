...
const ToysTable = ({ toys, index, setToys, allToys }) => {
  const { name, email, img, price, description, category, quantity, ratings, _id } = toys;
    ...
    <tr>
      ...
      <th>
        <div className="flex gap-4">
          <Link to={`/updateToys/${_id}`}><button className="btn btn-md bg-gray-700">Edit </button></Link>
