    ...
    return (
        <div className='max-w-7xl  mx-auto'>
            ...
            <div className="flex flex-col items-center justify-center mt-20 bg-gray-100">
                <Link to="/" className="px-4 mb-8 py-2 mt-8 bg-gray-600 text-white rounded hover:bg-gray-800 transition duration-300 ease-in-out ">
                    Go back to home
                </Link>
                ...
                <p className="text-gray-700 mb-8">We apologize for the inconvenience.</p>
